...
<h1>execAsyncScript</h1>
 ...
 the URL (get method)  http://server-ip-or-name/bldb/schedulerAPI?method=getScriptResult&token=[result-token]
...
<h1>executeR_queue</h1>
 ...
 <code> queue info in XML format 
  ...
  <u>Example:</u>
   http://server-ip-or-name/bldb/schedulerAPI?method=executeR_queue&server_ip=10.153.64.45
 <hr> 
