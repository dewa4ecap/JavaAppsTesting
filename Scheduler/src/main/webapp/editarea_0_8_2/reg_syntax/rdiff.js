editAreaLoader.load_syntax["rdiff"] = {
	 'DISPLAY_NAME' : 'SVN Diff'
	,'COMMENT_SINGLE' : {1 : '#'}
	,'COMMENT_MULTI' : {'/*' : '*/'}
	,'QUOTEMARKS' : {1: "'", 2: '"'}
	...
	,'KEYWORDS' : {
		...
		,'function4e' : [
			// common functions for Window object
			//'getRACEUniverse','getContractReference'
	...
	,'REGEXPS' : {			// advance syntax highlight through regexp
		'diffadd' : {		// the name 'doctype' can be changed with no problem.
			 'search' : '^\-\-\-'	// the regexp
			,'class' : 'diffadd'			// the css class
	...
	,'STYLES' : {
		 'COMMENTS': 'color:#4E8975;'
		,'QUOTESMARKS': 'color: #6381F8;'
		,'KEYWORDS' : {
			 'statements' : 'color:#151B8D;'
			,'keywords' : 'color:#60CA00;'
			,'functions' : 'color: #2B60FF;'
			,'function4e' : 'color:#B93B8F;text-decoration: underline;'
		}
		,'OPERATORS' : 'color: #FF00FF;'
		,'DELIMITERS' : 'color:#FF0000;'
		,'DELIMITERS1' : 'color:#151B8D;'
		,'REGEXPS' : {
			'deleted': 'color: #B1AC41;'
