<%@page import="com.fourelementscapital.scheduler.common.SchedulerReportClient"%>
...
com.fourelementscapital.p2p.*,
com.fourelementscapital.scheduler.*,
com.fourelementscapital.common.*,
com.fourelementscapital.engines.*,
com.fourelementscapital.alarm.*,
com.fourelementscapital.loadbalance.ScheduledTaskFactory,
java.util.*,
com.fourelementscapital.scheduler.common.SchedulerMgmt" errorPage="error.jsp"  %>

<%
String ky=(String)session.getAttribute(Constant.SESSION_LOGGED_USER);
if(ky==null || (ky!=null && ky.equals(""))){ 
	String referer=(request.getServletPath()!=null)?request.getServletPath():"/scheduler.jsp";
%>
...
<%
if(!Config.getValue("load_balancing_server").equals(P2PService.getComputerName())){ 
...
<script type='text/javascript' src='dwr/interface/IExecAccessMgmt.js'></script>
