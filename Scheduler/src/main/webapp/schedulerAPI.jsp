...
<h1>run</h1>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=run&ids=21,22
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=run&ids=21,22&delay=15
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=livepeers
 <hr> 
 </pre>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=queue
 <hr> 
 </pre> 
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=getPeerQueue
 <hr> 
 </pre> 
 ...
 <u>Example:</u> 
 http://server-ip-or-name/scheduler/schedulerAPI?method=syncContract&contract=CL010
 http://server-ip-or-name/scheduler/schedulerAPI?method=syncContract 
 <hr> 
 </pre> 
 ...
 <u>Example:</u> 
 http://server-ip-or-name/scheduler/schedulerAPI?method=syncSecurity&contract=AIGC
 http://server-ip-or-name/scheduler/schedulerAPI?method=syncSecurity 
 <hr>
 </pre> -->
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=restartPeer&peer=4ecappcsg10
 <hr> 
 </pre>
 ...
 <u>Example1:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=restartAfterDone&peer=4ecappcsg10
 <u>Example2:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=restartAfterDone&peer=4ecappcsg10&kill=1205
 <hr> 
 </pre>
...
<h1>restartServer</h1>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=restartServer
 <hr> 
 </pre>
 -->
...
<h1>addGroupIntoQueue</h1>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=addGroupIntoQueue&taskuid=rscriptlowpriority
 <hr> 
 </pre>
...
<h1>removeGroupFromQueue</h1>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=removeGroupFromQueue&taskuid=rscriptlowpriority
 <hr> 
 </pre>
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=getPeerPackages
 <hr> 
 </pre> 
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=getPeerInfo
 <hr> 
 </pre> 
 ...
 <u>Example: to show current settings</u> http://server-ip-or-name/scheduler/schedulerAPI?method=priorityQueue
 <u>Example: to enable</u> http://server-ip-or-name/scheduler/schedulerAPI?method=priorityQueue&enable=true
 <hr> 
 </pre>  
...
<h1>removeExecutingTask</h1>
 ...
 <u>Example:</u>http://server-ip-or-name/scheduler/schedulerAPI?method=removeExecutingTask&task_id=9999&trigger_time=9080808878979943
 <hr> 
 </pre> 		
 ...
 <u>Example:</u> http://server-ip-or-name/scheduler/schedulerAPI?method=getCurrentDateTime
 <hr> 
 </pre> 
...
<h1>execAsyncScript</h1>
 ...
 the URL (get method)  http://server-ip-or-name/scheduler/schedulerAPI?method=getScriptResult&token=[result-token]
...
<h1>strategyXML</h1>
 ...
 <code> Strategy in XML format 
  ...
  <u>Example:</u>
   http://server-ip-or-name/scheduler/schedulerAPI?method=strategyXML&stragegy=IDS&contract=CL1
 <hr> 
 
 </pre> 
				
		
<h1>executeR_queue</h1>
 This method gets executeR queue information
  <pre>

 <u>Parameters:</u>server_ip=&lt;ip of executeR server&gt; (example:10.153.64.45)  
  
 <u>Returns:</u>  
 <code> queue info in XML format 
 </code>
 
  <u>Example:</u>
   http://server-ip-or-name/scheduler/schedulerAPI?method=executeR_queue&server_ip=10.153.64.45
 <hr> 
