...
var EditArea_reditorlite= {
	...
	init: function(){	
		...
		editArea.load_css(this.baseURL+"css/reditor_task.css");		
	...
	,onload: function(){ 
		...
		parent.$j("#textarea",document).bind("dblclick",{doc: document},function(event){
			...
			if(typeof parent.scd_openFunction=='function' && txt!=null && txt!=''){
					parent.scd_openFunction(txt);
			}
...
editArea.add_plugin("reditor_task", EditArea_reditorlite);
