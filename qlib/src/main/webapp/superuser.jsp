...
if(action!=null && action.equalsIgnoreCase("logout")){
	...
	//referer=(request.getParameter("referer")!=null)?request.getParameter("referer"):"qlib.jsp";
	...
	<script language="JavaScript">
	   <%
	     ...
	     if(ref!=null && (ref.startsWith("http://") || ref.startsWith("https://")) ){
	         ...
	         //out.println("su.referer='"+((ref!=null)?"/qlib"+ref:"")+"';");
	    	 out.println("su.referer='"+((ref!=null)?ref:"")+"';");
	     }
